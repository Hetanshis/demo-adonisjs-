...
export default class PostValidator {
  ...
  public schema = schema.create({
    ...
    body: schema.string({}, [rules.minLength(5), rules.maxLength(50)]),
  });
  ...
  public messages = {
    ...
    "body.minLength": "Body must contain at least five characters.",
    "body.maxLength": "Body should be able to maximum 50 characters.",
  };
}
