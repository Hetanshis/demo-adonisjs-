  ...
  */
  interface ProvidersList {
    ...
    */
    ...
    distributor: {
      implementation: LucidProviderContract<typeof Distributor>;
      config: LucidProviderConfig<typeof Distributor>;
    };
  }
  ...
  */
  interface GuardsList {
    ...
    */
    ...
    web: {
      implementation: OATGuardContract<"admin", "web">;
      config: OATGuardConfig<"admin">;
      client: OATClientContract<"admin">;
    };
    dist: {
      implementation: OATGuardContract<"distributor", "dist">;
      config: OATGuardConfig<"distributor">;
      client: OATClientContract<"distributor">;
    };
  }
}
